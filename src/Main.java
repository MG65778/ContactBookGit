...
public class Main {
    ...
    public static final String NMR_DIFF = "All contacts have different phone numbers.";
    public static final String NMR_SHARE = "There are contacts that share phone numbers.";
